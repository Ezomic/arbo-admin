 ...
 */
#[Fillable(['id', 'name', 'first_name', 'last_name', 'email', 'phone_number', 'preferred_locale', 'timezone', 'current_role', 'tenant_id', 'accessible_apps', 'identity_synced_at', 'last_login_at', 'last_login_ip'])]
