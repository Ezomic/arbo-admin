        ...
        >
            ...
            <div class="grid gap-2">
                ...
                <Input
                    id="description"
                    name="description"
                    :default-value="taskType.description ?? undefined"
            ...
            <fieldset class="grid gap-3">
                <legend class="text-sm leading-none font-medium">
                    Auto-create when case type is
                </legend>
                <p class="text-xs text-muted-foreground">
                    A task of this type is created automatically in the dossier
                    when an open case matches all the conditions selected across
                    this form. Leave everything unchecked to keep this a
                    manual-only task type.
                </p>
                <div class="grid gap-2">
                    <div
            ...
            <fieldset class="grid gap-3">
                <legend class="text-sm leading-none font-medium">
                    Auto-create when milestone is due
                </legend>
                <div class="grid gap-2">
                    <div
                    ...
                    >
                        <Checkbox
                            ...
                            :default-checked="
                                enabledMilestones.includes(milestone.value)
                            "
                        />
                        <Label
                            :for="`milestone_${milestone.value}`"
                            class="font-normal"
            ...
            <fieldset class="grid gap-3">
                ...
                <div class="flex items-center gap-2">
                    ...
                    />
                    <Label
                        for="return_date_overdue_condition"
                        class="font-normal"
                        >Return date overdue</Label
                    >
                </div>
                <InputError
                    :message="errors['return_date_overdue_condition']"
                />
            </fieldset>
